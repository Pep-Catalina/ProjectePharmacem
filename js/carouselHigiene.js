...
let imgArrRoute = ["../img/higiene1.png", "../img/higiene2.png", "../img/higiene3.png"];
let imgArrAlt = ["Una persona relaxada", "Persona pasantse el fil dental", "Persona d'avançada edat dutxant-se"];
